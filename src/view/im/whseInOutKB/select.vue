...
import { mainCrudSelect1, mainFormSelect, mainFormSelect1} from "../../proMng/dyeDeliveryNote/data";
import {mainCrudSelect} from "./data"
...
export default {
  ...
  data() {
    ...
    query() {
      let params = queryParms(this.form, ["pidNo"], this.page);
    ...
    save() {
      ...
      this.choice.map((e, i) => {
        arr.push({
          ...
          realGramWeight:e.realGramWeight,
          weightUnit:"公斤/Kg"
        })
      })
