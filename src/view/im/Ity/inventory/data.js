 ...
 * @LastEditTime: 2023-04-03 16:34:53
 * @Description:
 */
  ...
  return {
    ...
    column: [
      ...
      },
      {
        ...
        span: 6,
        placeholder: " ",
        display :["SX", "RHL", "RLL"].includes(_this.type) ? true : false,
      },
      {
        label: "在库时长",
        prop: "inStorageDays",
        formslot: true,
        span: 6,
        display :["PB","SX", "RHL", "RLL"].includes(_this.type) ? true : false,
      }
    ]
  };
}
  ...
  return {
    ...
    column: [
      ...
      },
      {
        ...
        width: 160,
        align: "center",
        hide: ["PB","SX", "RHL", "RLL"].includes(_this.type) ? false : true,
        overHidden: true
      },
      {
        label: "在库时长",
      ...
      },
      {
        ...
        align: "center",
        overHidden: true,
        hide: ["SX", "RHL", "RLL"].includes(_this.type) ? false : true,
      },
      {
        label: "申购单号",
        prop: "applyNo",
      ...
      },
      {
        ...
        align: "center",
        overHidden: true,
        hide: ["SX"].includes(_this.type) ? false : true,
      },
    ]
  };
}
