...
<template>
  <div class="bottomColumn-list">
    <div class="btnList">
      <el-button type="warning" @click="update" :disabled="loading" v-hasPerm="['quality:qtyButtonColumn2:update']"
                 style="margin-right: 7px">
        {{ this.$t("public.update") }}
      </el-button>
      <el-popconfirm :title="$t('tipLabel.pirntConfirm')" placement="top-start" @onConfirm="handlePrint"
                     style="margin-right: 10px" v-hasPerm="['quality:qtyButtonColumn2:print2']">
        <el-button type="primary" slot="reference" :disabled="!cellClickData.fcardId">{{
            this.$t("public.print")
          }}
        </el-button>
      </el-popconfirm>
      <el-button type="danger" @click="handleDel" :disabled="!cellClickData.fcardId" v-hasPerm="['quality:qtyButtonColumn2:del2']">
        {{ this.$t("public.del") }}
      </el-button>
      <el-button type="primary" @click="handleQuery" :disabled="loading" v-hasPerm="['quality:qtyButtonColumn2:list2']">
        {{ this.$t("public.query") }}
      </el-button>
    </div>
...
import {axiosDel} from "../../im/Wk/cc/actionCloth/api";
