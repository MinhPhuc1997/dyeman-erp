<template>
  <view-container title="修改">
    <div class="btnList">
      <el-button type="success" @click="save" :disabled="loading" v-hasPerm="['quality:qtyButtonColumn:update']">
        {{ this.$t("public.save") }}
      </el-button>
      <el-button type="warning" @click="exit" :disabled="loading" v-hasPerm="['quality:qtyButtonColumn:update']">
        {{ this.$t("public.close") }}
      </el-button>
    </div>
    <div class="formBox">
