...
<template>
  <div id="return-yarn-container">
    <el-tabs v-model="tabName" type="border-card">
      <el-tab-pane name="clothInStoreNotice" :label="$t('proClothStkinMemo.title1')" v-hasPerm="['quality:stkinMemo:tab1']">
        <whse-in ref="whseInRef"  @click-row="handleClickStkinMemoRow"></whse-in>
      </el-tab-pane>
      <el-tab-pane name="clothUnStore" :label="$t('proClothStkinMemo.title2')" v-hasPerm="['quality:stkinMemo:tab2']">
