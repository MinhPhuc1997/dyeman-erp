    ...
    >
      <el-row class="btnList">
        ...
        <div style="float: right; margin-right: 5px">
          {{ $t("public.fuzzyQuery") }} <el-switch v-model="hasFuzzy" :active-text="$t('open')" :inactive-text="$t('close')">
          </el-switch>
        </div>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    handleFinish(){
      ...
      this.$confirm(`${this.$t('weaveJob.finishedConfirm1')} ${weaveJobCode} ${this.$t('weaveJob.finishedConfirm2')}`,this.$t("tips"),{type: "warning"}).then(res => {
        this.loading = true;
