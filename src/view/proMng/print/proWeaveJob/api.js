 ...
 * @LastEditTime: 2023-03-13 11:48:14
 * @Description:
 */
...
// 通过织单获取原织单号的织胚数量
export function fetchAmount2Weaved(weaveCode){
  return axios({
    url: "/api/proWeaveJob/ed/amount/" + weaveCode,
    method: "get",
  });  
}
...
// 配纱确认
export function fetchAllocConfirm(params){
  return axios({
    url: "/api/whseYarnsAccount/weave/alloc/confirm",
    method: "get",
    params: params
  });
}
...
// 配纱确认校验
export function fetchConfirmValid(dataList){
  return axios({
    url: "/api/whseYarnPreAllocDtl/extract/valid",
    method: "post",
    data: dataList
  });
}
...
export function fetchResultByBatchNo(params){
  return axios({
    url: "/api/proWeaveJobYarn/try/result/byBatchNo",
    method: "get",
    params: params
  })
}
...
// 判读当前部分是否为配纱部
export function judgeHasPsDpt(){
  return axios({
    url: "/api/ucmlUser/valid/include/dpt",
    method: "get",
    params: {dptCode: "peisha"}
  });
}
