        ...
        .then(res => {
          ...
          this.$axios
            ...
            .then(res => {
              ...
              this.LdData.colorLights = res.data[0].colorLights;
              this.LdData.recStandard = res.data[0].recStandard;
              this.LdData.testRequest = res.data[0].testRequest;
              //获取客户信息
              this.$axios
                .get("/api/basCustomer?custCode=" + res.data[0].custId)
                .then(res => {
